 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/PersonService/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://service/", "PersonService");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://service/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "PersonWebServicePort"), PersonWebService.class, features);
    }
