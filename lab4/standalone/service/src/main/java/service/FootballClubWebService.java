...
public class FootballClubWebService {
    ...
    public List<FootballClub> getFootballClubs(
            ...
            @WebParam(name = "footballClubAge") Integer age) throws DefaultException {
    ...
    public Integer addFootballClub(
            ...
            @WebParam(name = "footballClubCountry") String country,
            @WebParam(name = "footballClubCity") String city,
            @WebParam(name = "footballClubAge") Integer age) throws DefaultException, FormatException {
    ...
    public Integer updateFootballClub(
            ...
            @WebParam(name = "footballClubCountry") String country,
            @WebParam(name = "footballClubCity") String city,
            @WebParam(name = "footballClubAge") Integer age) throws DefaultException, DataNotFoundException, FormatException {
    ...
    public Integer deleteFootballClub(
            @WebParam(name = "footballClubId") Integer id) throws DefaultException, DataNotFoundException, FormatException {
